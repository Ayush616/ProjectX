...
<body>
<nav class="navbar fixed-top navbar-dark bar bg-light navbar-expand-lg">
        ...
        <div class="container">
            ...
            <div class="p-5 dash">
                <div class="row text-light wel">
                    <p><?php echo "Welcome to your dashboard, $name"; ?></p>
                    <hr>
                </div>
            ...
            <div class="service">
                ...
                <div class="services">
                    <div class="row c justify-content-center">

                        <div class="col-xl-4 col-6 c">
                        ...
                        <div class="col-xl-4 col-12 c ">
                            <div class="announcements mx-auto">
