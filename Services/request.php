...
<head>
    ...
    <link rel="stylesheet" href="request-css.css">
...
<div id="wrapper">
    ...
    <div id="sidebar-nav">
        ...
        <ul class="sidebar-ul">
            ...
            <li class="this-pg-opened"><a href=""><i class="fab fa-servicestack"></i><span>Services</span></a></li>
    ...
    <div id="content">
        <div class="container-fluid">
                <div id="services-nav" class="">
                        <ul>
                            <li><a href="../services.php">Manage SR</a></li>
                            <li class="service-tab-clicked"><a href="Services/request.php">Request Service</a></li>
                            <li><a href="track.php">Track SR</a></li>
                            <li><a href="cancel.php">Cancel SR</a></li>
                        </ul>
                 </div>
