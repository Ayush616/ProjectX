...
<div id="wrapper">
    ...
    <div id="sidebar-nav">
        ...
        <ul class="sidebar-ul">
            <li class="this-pg-opened"><a href="clients.php"><i class="fas fa-home"></i><span>Home</span></a></li>
            <li><a href=""><i class="fas fa-wallet"></i><span>Transactions</span></a></li>
            <li><a href="services.php"><i class="fab fa-servicestack"></i><span>Services</span></a></li>
            <li><a href=""><i class="fas fa-headset"></i></i><span>Support</span></a></li>
            <li><a href=""><i class="fas fa-comments"></i><span>Feedback</span></a></li>
        </ul>
